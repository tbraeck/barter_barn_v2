  ...
  return (
    <div className="headerCont">
     ...
     {user ? (
       ...
       <div  type='button' className='btn btn-primary red' style={{ backgroundColor:" rgb(300 , 200, 200)", color: 'black' }}>
...
{user ? (
    <Link to="/create_post" className='btn'>
        <div  type='button' className='btn btn-secondary'  style={{ backgroundColor:" rgb(300 , 200, 200)", color: 'black' }}>
    ...
    {user ? (
        <div className='btn '>
          ...
          <button type='submit' onClick={handleLogoutClick} className='btn btn-secondary' style={{ backgroundColor:" rgb(300 , 200, 200)", color: 'black', marginLeft: "0px" }} >LOGOUT</button>
        </div>
      ) : 
      <Link to="/login" className='btn'>
        <div  type='button' className='btn btn-secondary' style={{ backgroundColor:" rgb(255, 179, 186)", color: 'black' }} >
